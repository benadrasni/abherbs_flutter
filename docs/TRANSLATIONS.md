...
- Skills: `/translate-de`, `/translate-sk`, `/translate-fr`, `/translate-cs`, `/translate-pl`, `/translate-ru`, `/translate-es`, `/translate-pt`, `/translate-ja`, `/translate-it`, `/translate-nl`, `/translate-uk`, `/translate-hu`, `/translate-da`, `/translate-sv`, `/translate-no` (copies in `ingest/skills/`)
