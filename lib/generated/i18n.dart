...
class S implements WidgetsLocalizations {
  ...
  String get scale_down_photos_subtitle => "Switch on when you don't see your photos after pick.";
  String get scale_down_photos_title => "Scale down observation's photos";
...
class $ja_JP extends S {
  ...
  @override
  String get subscription_disclaimer_android => "最初の支払いは、購入確認から30日後にGoogle Playアカウントに請求されます。 現在の期間が終了する少なくとも24時間前にキャンセルされない限り、サブスクリプションは自動的に更新されます。 あなたのアカウントは、現在の期間の終了前に24時間以内に更新のために課金されます。 購入後にGoogle Playストアのアカウント設定にアクセスして、購読を管理およびキャンセルできます。";
  @override
...
class $pa_IN extends S {
  ...
  @override
  String get subscription_disclaimer_android => "ਖਰੀਦਾਰੀ ਦੀ ਪੁਸ਼ਟੀ ਤੋਂ 30 ਦਿਨਾਂ ਬਾਅਦ ਤੁਹਾਡੇ ਅਦਾਇਗੀ ਦਾ ਭੁਗਤਾਨ ਤੁਹਾਡੇ Google Play ਖਾਤੇ ਤੋਂ ਲਿਆ ਜਾਵੇਗਾ. ਗਾਹਕੀ ਆਪਣੇ ਆਪ ਤਾਜ਼ਾ ਹੋ ਜਾਂਦੀ ਹੈ ਜਦੋਂ ਤਕ ਇਹ ਚਾਲੂ ਮਿਆਦ ਦੇ ਸਮਾਪਤ ਹੋਣ ਤੋਂ ਘੱਟੋ-ਘੱਟ 24 ਘੰਟੇ ਰੱਦ ਨਹੀਂ ਹੁੰਦੀ. ਤੁਹਾਡੇ ਅਕਾਉਂਟ ਨੂੰ ਮੌਜੂਦਾ ਸਮੇਂ ਦੇ ਅੰਤ ਤੋਂ 24 ਘੰਟਿਆਂ ਦੇ ਅੰਦਰ ਅੰਦਰ ਨਵੀਨੀਕਰਨ ਲਈ ਚਾਰਜ ਕੀਤਾ ਜਾਵੇਗਾ. ਤੁਸੀਂ ਖਰੀਦਣ ਤੋਂ ਬਾਅਦ Google Play Store ਤੇ ਆਪਣੀਆਂ ਖਾਤਾ ਸੈਟਿੰਗਾਂ ਤੇ ਜਾ ਕੇ ਆਪਣੀ ਗਾਹਕੀ ਦਾ ਪ੍ਰਬੰਧਨ ਅਤੇ ਰੱਦ ਕਰ ਸਕਦੇ ਹੋ.";
  @override
